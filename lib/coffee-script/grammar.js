...
(function() {
  ...
  grammar = {
    ...
    Line: [o('Expression'), o('Statement'), o('YieldReturn'), o('AwaitReturn')],
    Statement: [
      o('Return'), o('Comment'), o('STATEMENT', function() {
        return new StatementLiteral($1);
      })
    ],
    Expression: [o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield'), o('Await')],
    Yield: [
      o('YIELD', function() {
