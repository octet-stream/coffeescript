...
(function() {
  ...
  UTILITIES = {
    ...
    includes: function() {
      return "function includes(arr, val) { var __ref = Array.prototype.includes; if (typeof __ref === \"function\") { return __ref.call(arr, val); } for (let __v of arr) { if (__v === val || (isNaN(__v) && isNaN(val))) { return true; } } return false; }";
    },
    modulo: function() {
