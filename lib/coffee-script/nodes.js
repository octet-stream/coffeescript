...
(function() {
  ...
  exports.Comment = Comment = (function(superClass1) {
    ...
    Comment.prototype.compileNode = function(o, level) {
      ...
      code = "/*" + (multident(comment, this.tab)) + (includes(comment, '\n') === true ? "\n" + this.tab : '') + " */";
  ...
  exports.Access = Access = (function(superClass1) {
    ...
    Access.prototype.compileToFragments = function(o) {
      ...
      if (node instanceof PropertyName) {
        if (ref3 = node.value, includes(JS_FORBIDDEN, ref3) === true) {
  ...
  exports.Class = Class = (function(superClass1) {
    ...
    Class.prototype.determineName = function() {
      ...
      if (includes(JS_FORBIDDEN, name) === true) {
        return "_" + name;
      } else {
        return name;
      }
  ...
  exports.Assign = Assign = (function(superClass1) {
    ...
    Assign.prototype.isStatement = function(o) {
      return (o != null ? o.level : void 0) === LEVEL_TOP && (this.context != null) && includes(this.context, "?") === true;
    };
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (this.context === 'object') {
        if (ref8 = fragmentsToText(compiledName), includes(JS_FORBIDDEN, ref8) === true) {
  ...
  exports.Code = Code = (function(superClass1) {
    ...
    function Code(params, body, tag) {
      ...
      this.isAwait = !!this.body.contains(function(node) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      code = this.isAwait && !o.generator ? (utility('asyncWrap', o)) + "(function" : 'function';
      if (this.isGenerator) {
        code += '*';
      }
      if (this.isAwait && !o.generator) {
        code += '*';
      }
      if (this.isAwait && o.generator) {
        code = "async " + code;
      ...
      if (this.isAwait || this.isGenerator) {
        code += ' ';
      }
      code += '(';
      ...
      answer.push(this.makeCode("}" + (this.isAwait && !o.generator ? ')' : '')));
      if (this.ctor) {
  ...
  exports.Op = Op = (function(superClass1) {
    ...
    Op.prototype.compileYield = function(o) {
      ...
      if (includes(Object.keys(this.first), 'expression') === true && !(this.first instanceof Throw)) {
    ...
    Op.prototype.compileAwait = function(o) {
      ...
      if (includes(Object.keys(this.first), 'expression') === true && !(this.first instanceof Throw)) {
        ...
        parts.push([this.makeCode(o.regenerator ? op : 'yield')]);
        if (((ref3 = this.first.base) != null ? ref3.value : void 0) !== '') {
          parts.push([this.makeCode(" ")]);
        }
        parts.push(this.first.compileToFragments(o, LEVEL_OP));
  ...
  exports.In = In = (function(superClass1) {
    ...
    In.prototype.compileLoopTest = function(o) {
      ...
      fragments = [].concat(this.makeCode(utility('includes', o) + "("), this.array.compileToFragments(o, LEVEL_LIST), this.makeCode(", "), ref, this.makeCode(") " + (this.negated ? '=== false' : '=== true')));
  ...
  UTILITIES = {
    ...
    bind: function() {
      return "function(fn, ctx){ return function(){ return fn.apply(ctx, arguments); }; }";
    },
    indexOf: function() {
      return "Array.prototype.indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) { return i }; } return -1; }";
    },
    includes: function() {
      return "function includes(arr, val) { var __ref = Array.prototype.includes; if (typeof __ref === \"function\") { return __ref.call(arr, val); } for (var __v of arr) { if (__v === val || (isNaN(__v) && isNaN(val))) { return true; } } return false; }";
    },
    modulo: function() {
